...
namespace BookStore.Api.Client.Contracts
{
    ...
    public partial interface IBooksClient
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.List<string>> GetAllAsync(System.Threading.CancellationToken cancellationToken);
